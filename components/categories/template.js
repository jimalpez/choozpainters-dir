export class CategoriesTemplate extends HTMLElement {
  constructor() {
    super();
    this.categories = [];
  }
  ...
  render() {
    this.innerHTML = `
        <div class="container margin_t_60 margin_b_120">
            <div class="row">
                <div class="col-12">
...
customElements.define("categories-template", CategoriesTemplate);
